...
class Player(BaseModel):
    ...
    nick_names: typing.Optional[typing.List[str]]
    cric_sheet_id: str
    ...
    id = fields.ObjectIdField(desc="Id of the player")
    age = fields.IntegerField(desc="Age of the player in years", default=0)
    ...
    education = fields.StringField(desc="Education of the player", default="")
    nationality = fields.StringField(desc="Nationality of the player", default="")
    birth_place = fields.StringField(desc="Birth place of the player", default="")
    ...
    name = fields.StringField(desc="Name of the player", mandatory=True)
    ...
    nick_names = fields.ListField(str, desc="Nicknames of the player", default=[])
...
class Stadium(BaseModel):
    ...
    city = fields.StringField(desc="City where the stadium is located")
...
class Outcome(BaseModel):
    ...
    is_draw: bool
    winner: typing.Optional[ObjectId]
    ...
    winner = fields.ObjectIdField(desc="Winning team id")
...
class Match(BaseModel):
    ...
    stage = fields.StringField(desc="Stage of the match (Group, Semi-final, Final)", default="")
    cric_sheet_id = fields.StringField(desc="Id of the player in cricsheet", mandatory=True)
...
class Delivery(BaseModel):
    ...
    fielders_involved = fields.ListField(ObjectId, desc="Ids of fielders involved in the wicket", default=[])
